...
Design update, 2026-09-20: all three arms now share the reference layout, numbered purple steps, and green WhatsApp icon button labeled "Join & Get My Coupon". Headlines, descriptions, assignment and outcome tracking are unchanged. The shared design changed during enrollment; interpret pooled results with that timing in mind.
