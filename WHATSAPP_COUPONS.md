...
- Apply migrations 002, 003, 004 and 005 in order using Wrangler D1 and `--config wrangler.toml`.
...
Popup A/B/C testing and the private results dashboard are documented in [WHATSAPP_EXPERIMENT.md](WHATSAPP_EXPERIMENT.md).
