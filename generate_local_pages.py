...
{footer_html()}
    ...
    <script src="/assets/city-coupons.js?v=zernio-5" defer></script>
</body>
</html>
"""
...
def main() -> int:
    ...
    with asset_path.open("w", encoding="utf-8") as fh:
        fh.write(modal_literal + COUPON_WIDGET_JS + '\n{ const script=document.createElement("script"); script.src="/assets/zernio-coupon-option.js?v=5"; document.head.appendChild(script); }\n')
