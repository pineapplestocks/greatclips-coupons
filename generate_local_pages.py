...
def salon_card(salon: dict, index: int) -> str:
    ...
    return f"""                <li class="p-5 border border-slate-200 rounded-xl bg-white">
                    ...
                    <button type="button" hidden
                            ...
                            data-zip="{esc(salon['zip'])}">Get Coupon on WhatsApp</button>
...
def main() -> int:
    ...
    with asset_path.open("w", encoding="utf-8") as fh:
        fh.write(modal_literal + COUPON_WIDGET_JS + "\n// Shared WhatsApp request routing.\n{ const script = document.createElement('script'); script.src = '/assets/whatsapp-entry.js?v=11'; document.head.appendChild(script); }\n")
