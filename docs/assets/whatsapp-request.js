(() => {
  ...
  const messages={expired:'This request is older than seven days. Choose a current coupon and start again.',awaiting_message:'Send the prefilled request in WhatsApp so we can match your number to your selected coupon.',awaiting_join:'Your request is linked. Join Deal Dropper with the same WhatsApp number. Membership checks run about once a minute.',awaiting_approval:'Your group membership is confirmed. Your coupon is waiting for admin approval.',approved:'Approved. Your coupon is queued for private WhatsApp delivery.',sending:'Your coupon is being sent. Please check your WhatsApp chat.',sent:'Your coupon was sent to your WhatsApp chat. Check the official terms before visiting.',uncertain:'We are checking the delivery result. Please do not submit another request.',rejected:'This request was not approved. You can reply in your WhatsApp chat for help.',cancelled:'Your request was cancelled.',unavailable:'This coupon is no longer available. Return to the website to choose a current offer.'};
